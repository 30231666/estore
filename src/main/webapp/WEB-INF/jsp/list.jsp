    ...
    <div class="container4">
    	...
    	<div class="c4_b1">
        	<ul class="c4_b1_boxes">
        		<c:forEach items="${topBooklist}" var="topbook">
            	<li>
                	<img src="${topbook.image}">
                    <div class="c4_b1_box_txt">
                    	<p>${topbook.name}</p>
                        <h1>活动价：<b>${topbook.price}</b></h1>
                        <h2><a href="ToViewBook?id=${topbook.id}">立即抢购</a></h2>
                    </div>
                </li>
                </c:forEach>
            </ul>
                	...
                	<li class="c4_b5_c_box">
                    	...
                    	<div class="c4_b5_c_box_pic">
                        	<div class="c4b5_pic_view">
                            	<a href="ToViewBook?id=${book.id}"><img src="${book.image}"></a>
                            </div>
                        </div>
                        <!--价钱-->
                        <div class="c4_b5_c_box_txt">
                        	<h1>${book.price}</h1>
                            <h2><a href="ToViewBook?id=${book.id}">${book.name}</a></h2>
                        </div>
                        <!--购买等操作-->
                        <div class="c4b5_el">
                        	<div class="c4b5_el_x">
                        ...
                        <ul class="c4b5_option">
                                <li class="shopcar_box"><span class="shopcar01"></span><a href="ToViewBook?id=${book.id}">加入购物车</a></li>
                        </ul>
                    </li>
                    </c:forEach>
                </ul>
