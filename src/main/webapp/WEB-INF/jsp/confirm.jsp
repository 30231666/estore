...
<body>
    ...
    <!--头部-->
    <div class="header3">
    	<a href="#"><img src="images/logo.png"  width="200px" height="100px" class="oneImg"></a>
    ...
    <div class="content">
		...
		<form action="ToOrderListServlet" name="orderForm">
    		...
    		<div class="centerTop">
    			...
    			<ul class="adres">
			    		...
			    		<li>
			    			...
			    			${address.receiveName}&nbsp;&nbsp;&nbsp;${address.phone}&nbsp;&nbsp;&nbsp;${address.address}</li>
						</c:forEach>
    		...
    		<div class="money">
    			<span><font>2</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost}</span>
    			<span><img src="images/sureLogo_18.png" alt="">运费：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥0.00</span>

    			<span>应付总额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${car.cost}</span>
    		</div>
    		<div class="submit">
    			<span>应付金额：<font>¥${car.cost}</font><input type="image" src="images/21_03.png"></span>
    		</div>
			</form>
    	</div>
